...
Original file is located at
    https://colab.research.google.com/drive/1BShpMM86ZCAW6yvad84dELV4SVtUuITK
"""
...
os.chdir("/content/drive/MyDrive/Major_project/2001/")
# Input land cover GeoTIFF for two time period
file1 = "clip_LE07_L1TP_137042_20010129_20170207_01_T1_Bstack_raster.tif"
file2 = "classify_areas.tif"
...
image_patches = patchify(newX, (5,5,6), step=1) 
...
import matplotlib
matplotlib.image.imsave('/content/drive/MyDrive/Major_project/2001/built-up_area_2001.tiff',class_new)
...
#mage_patches = np.reshape(image_patches, (image_patches.shape[0],image_patches.shape[3],image_patches.shape[2],image_patches.shape[1]))
...
history=model.fit(X_train, y_train1, batch_size=128, epochs=10,validation_split=0.2) #model.fit(train_images, train_labels, validation_data=(test_images, test_labels), epochs=5)
